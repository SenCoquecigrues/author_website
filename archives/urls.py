...
urlpatterns = [
    ...
    path('<int:story_id>/story/delete', login_required(views.story_delete), name="story_delete"),
    # Chapter
    ...
    path('<int:chapter_id>/chapter/delete', login_required(views.chapter_delete), name="chapter_delete"),
    # Exports
