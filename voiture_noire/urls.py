...
urlpatterns = [
    ...
    path('prompts/would_not_create/<int:prompt_id>', views.would_not_create, name='would_not_create'),
    path('prompts/would_create/<int:prompt_id>', views.would_create, name='would_create'),
    path('prompts/would_not_receive/<int:prompt_id>', views.would_not_receive, name='would_not_receive'),
    path('prompts/would_receive/<int:prompt_id>', views.would_receive, name='would_receive'),
